...
public class ActionsPractices {
   ...
   @Test
    ...
    public void task_4_and_5_test(){
       ...
       Driver.getDriver().get("https://practice.cydeo.com/");
                ...
                // Create object of our actions and pass our "driver" instance
   ...
   @Test
    public void test2(){
       Driver.getDriver().get("https://practice.cydeo.com/");
      // Driver.closeDriver(); // closeDriver() is in red because in utility close i have to set  up close method
   }
