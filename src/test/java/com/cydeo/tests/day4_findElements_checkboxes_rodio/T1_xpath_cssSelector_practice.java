...
public class T1_xpath_cssSelector_practice {
    ...
    public static void main(String[] args) {
        ...
        //          locate homelink using cssSelector, by using href value
        ...
        WebElement header_ex2 = driver.findElement(By.xpath("//h2[text()='Forgot Password']"));//exactly same of this:
        ...
        // button[@type='submit'] and button[@class='radius'] --> give the same result
        ...
        //  Then solve the task using XPATH only. Try to create 2 different XPATH locators if possible.
    }
}
