...
public class T1_Registration_Form {
    ...
    public void registration_form_test(){
        ...
        //inputUserName.sendKeys(faker.name().username()); //we had a message from website as
                            // "The username can only consist of alphabetical and number), so:
        // this coming line is optional it is just we want to use username in the following line as well
